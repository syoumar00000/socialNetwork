...
class _LogState extends State<LogController> {
              ...
              child: SafeArea(
                child: Column(
                  children: <Widget>[
                    ...
                    PaddingWith(widget: Menu2Items(item1: "Connection", item2: "Inscription", pageController: _pageController) , top: 20.0, bottom: 20.0,),
  ...
  //creation widgetpour gerer afficher les elements de la connection ou de l'inscription
    ...
    return Column(
      children: <Widget>[
        ...
        PaddingWith(
          top: 15.0,
          bottom: 15.0,
          widget: ButtonGradient(callback: signIn((index == 0)),text: (index == 0)? "Se Connecter" : "S'inscrire"),
        ),
      ],
    );
  }
  ...
  List<Widget> listItems(bool exists) {
    List<Widget> list = [];
    if(!exists){
      list.add(MyTextField(controller: _name, hint: "Entrez votre nom svp", type: TextInputType.text,));
      list.add(MyTextField(controller: _surname, hint: "Entrez votre prenom svp",type: TextInputType.text,));
    }
    list.add(MyTextField(controller: _mail, hint: "Entrez votre mail svp", type: TextInputType.emailAddress,));
    list.add(MyTextField(controller: _pwd, hint: "Entrez votre mot de passe svp", obscure: true,));
    return list;
  }
