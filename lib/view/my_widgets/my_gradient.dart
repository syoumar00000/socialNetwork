...
// ceci est une classe dheritage pour gerer le degradé
class MyGradient extends BoxDecoration {
  ...
  MyGradient({@required Color startColor, @required Color endColor,bool horizontal: false, double radius: 0.0}) : super(
