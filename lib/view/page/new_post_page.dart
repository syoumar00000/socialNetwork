...
class _NewPostState extends State<NewPost> {
      ...
      child: Container(
        ...
        child: InkWell(
          ...
          child: Column(
            ...
            children: <Widget>[
              PaddingWith(widget:MyText("Ecrivez quelque chose...",color: baseAccent, fontSize: 30.0,)
                ,top: 25.0,),
              PaddingWith(widget: Container(
                width: MediaQuery.of(context).size.width, height: 1.0, color: baseAccent,),),
              PaddingWith(widget: MyTextField(
                controller: _controller,
                hint: "Exprimez-vous",icon: writeIcon,
 ...
 Future<void> takePicture(ImageSource source) async {
   PickedFile image = await ImagePicker().getImage(source: source, maxWidth: 500.0, maxHeight: 500.0);
   setState(() {
